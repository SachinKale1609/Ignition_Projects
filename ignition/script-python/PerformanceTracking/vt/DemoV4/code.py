...
def getRecipeRunInfo(rootTagPath, machineName, start, end):
    ...
    recipeRunDataFromDB = PerformanceTracking.vx.DemoV4_retrieveRecipeRunDB.main(rootTagPath, machineName, start, end)
    print ''
    print type(start)
    optmizedStart = PerformanceTracking.vx.DemoV4_retrieveRecipeRunDB.getMaxEndTime(recipeRunDataFromDB)
...
def main(systemNames, shiftStartHours):
    ...
    for systemName in systemNames:
        ...
        for machineName in machineNames:
            ...
            print(recipeRunData)
            PerformanceTracking.vx.DemoV4_upsertRecipeRunDB.main(recipeRunData,systemName,machineName)
